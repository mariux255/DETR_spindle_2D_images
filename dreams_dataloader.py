...
class dreams_dataset(Dataset):
    def __init__(self, input_path = '/home/marius/Documents/thesis/data/DREAMS/windowed/real/', label_path = '/home/marius/Documents/thesis/data/DREAMS/windowed/labels/'):
